...
DroneerX6 is being upstreamed to PX4 in <https://github.com/PX4/PX4-Autopilot/pull/27742>. PX4 reviewers requested that the board stop using Auterion's USB VID `0x3185`, so DroneerX6 needs a public and traceable USB VID/PID allocation under the pid.codes VID `0x1209`.
